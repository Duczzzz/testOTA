...
const char* firmwareUrl = "https://raw.githubusercontent.com/Duczzzz/testOTA/main/firmware_adminpro.ino.bin";
...
void getupdate()
{
    ...
    Firebase.setInt(fbdo, "/users/adminpro/updateOTA",0);  
...
void loop() {
  if(Firebase.getInt(fbdo, "/users/adminpro/updateOTA")) checkupdate = fbdo.intData();
  if(checkupdate == 1) {
    display.clearDisplay();
    display.setTextSize(1);
    display.setCursor(0, 0);
